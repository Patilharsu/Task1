// Project ! creating the java project ATM Interface
...
class BankAccount {
    ...
    void checkId() {
        ...
        System.out.println();
        System.out.print("Enter the Customer ID or PIN: ");
    ...
    private void showMenu() {
        ...
        do {
            System.out.println("\n");
            System.out.println("\n");
            System.out.println("A. Check Balance User");
            System.out.println("B. Deposit Cash");
            System.out.println("C. Withdraw Cash");
            System.out.println("D. Previous Transaction User");
            System.out.println("E. Transfer Cash");
            System.out.println("F. Exit For Transaction");
...
class second {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Gaurav", "4555");
        ba.checkId();
    }
